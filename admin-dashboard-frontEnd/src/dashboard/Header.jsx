...
const Header = ({ setEditProfile, setViewProfile }) => {
    ...
    <div>
      ...
      <nav className="main-header navbar navbar-expand navbar-white navbar-light">
        ...
        <ul className="navbar-nav">
          ...
          <li className="nav-item d-none d-sm-inline-block">
            <Link to="#" onClick={() => { setEditProfile(true); setViewProfile(false); }} className="nav-link">Profile</Link>
          </li>
        </ul>
        {/* Right navbar links */}
          ...
          <li className="nav-item dropdown">
            ...
            <div className="dropdown-menu dropdown-menu-right">
              ...
              <a href="#" className="dropdown-item" onClick={() => {
                setViewProfile(true);
                setEditProfile(false); // Ensure editProfile is false
              }}>
              ...
              <a href="#" className="dropdown-item" onClick={() => {
                setEditProfile(true);
                setViewProfile(false); // Ensure viewProfile is false
              }}>
